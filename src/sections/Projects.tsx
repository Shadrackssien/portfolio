...
export const ProjectsSection = () => {
  return (
    <div className="font-sans pb-16 lg:py-24">
      <div className="container">
        ...
        <div className="flex flex-col gap-20 mt-10 md:mt-20">
          {portfolioProjects.map((project) => (
            <div
              key={project.title}
              className="px-8 pt-8 md:pt-12 md:px-10 lg:pt-16 lg:px-20 bg-gray-800 rounded-3xl border border-white/40 relative z-0 overflow-hidden 
              after:z-10 after:content-[''] after:absolute after:inset-0 after:outline-2 after:outline 
              after:outline-offset-2 after:pointer-events-none after:rounded-3xl after:outline-white/20"
            >
              <div
